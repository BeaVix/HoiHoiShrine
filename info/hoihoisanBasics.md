...
The year is 20XX, a future where bugs have become immune to all pesticides. Pests are reproducing at an alarming rate, to combat this threat, the company *Mars Pharmaceutical* mass-produces a small, highly-customizable, highly-marketable, exterminator robot known as *HoiHoi-San*. This would bring about the era of interceptor dolls.

The audience gets to experiende the <del>derangement</del> daily lives of people now co-existing with these dolls through a rotating cast of characters: Aburatsubo, the main protagonist, a guy that doesn't have much going on who becomes obsessed with them; Kimiko Dewa, a pharmacist that is disgusted by the sigth of HoiHoi-San dolls; Furuyashiki, the product development chief at Mars Pharmaceutical who tries to keep HoiHoi-San in line with his vision; and Mutsumi "Mu-Chan" Shinazugawa, friend of Kimiko who loves HoiHoi-San, and who is a bit of a sociopath.

<div style="display: grid; grid-auto-flow: column; grid-template-columns: 25% 25% 25% 25%; margin-top:30px">
    {% include image-caption.html img='aburatsubo.png' alt='Aburatsubo' caption='Aburatsubo' %}
    {% include image-caption.html img='kimiko.png' alt='Kimiko' caption='Kimiko' %}
    {% include image-caption.html img='furuyashiki.png' alt='Furuyashiki' caption='Furuyashiki' %}
...
- [The OVA](https://youtu.be/A6jJ9sV52l4?feature=shared)
- [*Ichigeki Sacchu!! HoiHoi-San LEGACY*]({{site.url}}/legacy.html), the sequel
- The cancelled OVA for the sequel (you can watch the trailer on Youtube)
- A re-release of the original, subtitled *NEW-EDITION*
- [*Amabie ver.*]({{site.url}}/info/AmabieVer.html) A "self-parody" one-shot about the COVID-19 pandemic. 
- A revised version of the *LEGACY* manga uploaded by the author on [Twitter](https://x.com/hoihoisanlegacy) and [Fanbox](https://www.fanbox.cc/@onevisions/posts) (contains some story-beat changes and re-drawings)
- Unofficial content by the author only in his doujin magazines (Most only limitedly avalible in Japan or through re-sellers)
- [Figures](https://myfigurecollection.net/?keywords=hoihoi-san&_tb=item), so many of them.
